...
class PolypDataset(data.Dataset):
    """
    dataloader for CAG segmentation tasks
    """
...
def get_loader(image_root, gt_root, batchsize, trainsize, shuffle=True, num_workers=12, pin_memory=True, augmentation=False):
